...
namespace SmartHotel.Services.Hotel
{
    public class FakeHotelService : IHotelService
    {
        ...
        public async Task<IEnumerable<Review>> GetReviewsAsync(int id)
        {
            ...
            return Reviews.Where(r => r.HotelId == id).ToObservableCollection(); // push item to ObservableCollectio. It help binding two way list item
        }
        ...
        public async Task<IEnumerable<Models.Hotel>> SearchAsync(int cityId, int rating, int minPrice, int maxPrice)
        {
            ...
            return Hotels
                ...
                .ToObservableCollection(); // push item to ObservableCollectio. It help binding two way list item
        }
